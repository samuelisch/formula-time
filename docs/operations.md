...
How FormulaTime is run: local ports and worktrees, deploys, the release, and where the live service's state lives. The architecture is in `architecture.md`; the rules for a change are in `AGENTS.md`.
