...
// effects. Always the private address ranges, never `true` (ADR-0024) --
// `true` would let a client forge its own resolved IP via
// X-Forwarded-For and dodge the vote route's per-IP rate limit. See
// README: Polls.
